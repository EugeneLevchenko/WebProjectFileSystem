...
public abstract class ServletBaseWithTableWithParam extends ServletBase {
    ...
    protected abstract void renderTable( HttpServletResponse resp,HttpServletRequest req) throws IOException, SQLException, IllegalAccessException, InvocationTargetException, InstantiationException;
